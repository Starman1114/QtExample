...
QT_MOC_LITERAL(1, 9, 5), // "beMin"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6), // "beExit"
QT_MOC_LITERAL(4, 23, 24), // "on_btnMenu_Close_clicked"
QT_MOC_LITERAL(5, 48, 22), // "on_btnMenu_Min_clicked"
QT_MOC_LITERAL(6, 71, 18) // "on_btnMenu_clicked"

    },
    "TitleBar\0beMin\0\0beExit\0on_btnMenu_Close_clicked\0"
    "on_btnMenu_Min_clicked\0on_btnMenu_clicked"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->beMin(); break;
        case 1: _t->beExit(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::beMin)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::beExit)) {
                *result = 1;
                return;
            }
        }
