...
QT_MOC_LITERAL(3, 14, 3), // "ind"
QT_MOC_LITERAL(4, 18, 9) // "sendIndex"

    },
    "GameList\0add\0\0ind\0sendIndex"
};
...
void GameList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameList::add)) {
                *result = 0;
                return;
            }
        }
