 ...
 * Return Type  : void
 */
  void Upchirp_api(const mxArray *prhs[4], const mxArray *plhs[1])
{
  real_T (*Up_chirp)[882];
  real_T fL;
  real_T fH;
  ...
  Up_chirp = (real_T (*)[882])mxMalloc(sizeof(real_T [882]));
  ...
  Upchirp(fL, fH, *t, T2, *Up_chirp);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Up_chirp);
}
...
/*
 * File trailer for _coder_Upchirp_api.c
 *
 * [EOF]
 */
