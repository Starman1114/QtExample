...
/**************************************************************************
    * 界面窗口操作
    */
bool MathW::eventFilter(QObject *obj, QEvent *event)
{
...
void MathW::mouseMoveEvent(QMouseEvent *e)
{
...
void MathW::mousePressEvent(QMouseEvent *e)
{
...
void MathW::mouseReleaseEvent(QMouseEvent *)
{
    mousePressed = false;
}

void MathW::on_btnMenu_Close_clicked()
{
    //qApp->exit();
    hide();
}

void MathW::on_btnMenu_Max_clicked()
{
    if (max) {
...
void MathW::on_btnMenu_Min_clicked()
{
    this->showMinimized();
}
