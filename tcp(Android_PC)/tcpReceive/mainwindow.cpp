    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->IPlabel->setText("服务器IP："+getIP()+" 端口号：6666");
}
...
{
    bytesReceived =0;
    if(!tcpServer.listen(QHostAddress(getIP()),6666))
    {
...
{
    QDesktopServices::openUrl(QUrl("E:/dataStore/"));
}
...
void MainWindow::updateServerProgress()  //更新进度条，接收数据
{
    ...
    { //如果接收到的数据小于16个字节，那么是刚开始接收数据，我们保存到//来的头文件信息
        ...
        {  //接收文件名，并建立文件
            ...
            localFile = new QFile("E:/dataStore/"+fileName);
