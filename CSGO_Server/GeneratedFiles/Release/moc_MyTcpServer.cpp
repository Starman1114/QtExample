...
QT_MOC_LITERAL(6, 41, 17), // "NewConnectionSlot"
QT_MOC_LITERAL(7, 59, 16), // "disconnectedSlot"
QT_MOC_LITERAL(8, 76, 8) // "ReadData"

    },
    "MyTcpServer\0getData\0\0data\0getResult\0"
    "type\0NewConnectionSlot\0disconnectedSlot\0"
    "ReadData"
};
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpServer::getData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTcpServer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpServer::getResult)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpServer::getData(QString _t1)
{
...
// SIGNAL 1
void MyTcpServer::getResult(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
